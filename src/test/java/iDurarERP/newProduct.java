...
public class newProduct {
    ...
    public void navigateToPage() {
        ...
        WebElement categoryLink = new WebDriverWait(driver, Duration.ofSeconds(10))
                .until(ExpectedConditions.elementToBeClickable(By.linkText("Products")));
        // Go to Companies page
        categoryLink.click();
    }

    @Test(priority = 2, dataProvider = "ProductData", dataProviderClass = dataProvider.class)
    public void addProduct(String name, String price, String desc, String ref){
        ...
        driver.findElement(By.cssSelector(".ant-col:nth-child(1) > .ant-spin-nested-loading:nth-child(1) #price")).sendKeys(price);
        driver.findElement(By.cssSelector(".ant-col:nth-child(1) > .ant-spin-nested-loading:nth-child(1) #description")).sendKeys(desc);
        driver.findElement(By.cssSelector(".ant-col:nth-child(1) > .ant-spin-nested-loading:nth-child(1) #ref")).sendKeys(ref);
        driver.findElement(By.cssSelector(".ant-col:nth-child(1) > .ant-spin-nested-loading:nth-child(1) #name")).sendKeys(Keys.TAB, Keys.ARROW_DOWN, Keys.ENTER);
